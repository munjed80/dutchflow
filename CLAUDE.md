...
- Pages: `/`, `/learn`, `/learn/[slug]`, `/learn/[slug]/listening`, `/learn/[slug]/writing`, `/exams`, `/progress`, `/account`, and `/placement`.
...
- Every lesson also has free guided writing at `/learn/[slug]/writing`, linked after its dialogue. It reuses the 101 known phrases: recall the lesson wording from the Arabic meaning, compare words/order, and rewrite after feedback. Read `docs/WRITING.md` before changing it. This is deterministic model comparison, not free-translation or grammar evaluation; alternate valid Dutch must not be labelled a linguistic error.
...
1. Review the 20 Dutch/Arabic lessons and 16 starting-point questions with a qualified language editor and add deeper A1 practice, especially new listening passages and guided original writing. Current listening and writing exercises reuse known lesson phrases; writing compares the lesson wording only.
