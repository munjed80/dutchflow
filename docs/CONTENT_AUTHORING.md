...
- Voice generation requires credentials and has not been run for this catalogue. The current 125 phrases correspond to 500 files with two voices and two speeds.
