...
- Voice generation requires credentials and has not been run for this catalogue. The current 231 phrases correspond to 924 files with two voices and two speeds.
