...
Every lesson links to `/learn/[slug]/writing`. The exercise reuses the 181 existing Dutch phrases and Arabic meanings across 30 introductory lessons. It asks the learner to recall the **lesson wording**, not translate freely. This exercise itself does not generate linguistic content or audio and does not require an AI service.
