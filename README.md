...
- Arabic RTL landing page and 32 introductory A1 lessons in four ordered modules. The catalogue includes 197 Dutch phrases, Arabic meanings, learning goals, short dialogues, a grammar note per lesson, and 108 graded questions.
- A `/curriculum` map links ten thematic goals to available resources and shows remaining work. Eighteen lessons include 108 vocabulary/form notes and 36 original-response tasks with optional models and self-review questions. These tasks are ungraded and temporary; see [A1 plan and readiness gates](docs/A1_CURRICULUM.md).
