...
test("mapping validation rejects broken links, duplicate assignments, and missing coverage or goals", () => {
  ...
  // A reading can belong to multiple themes; remove it from every theme to test missing coverage.
  for (const unit of copy) unit.readingSlugs = unit.readingSlugs.filter((slug) => slug !== readings[0].slug);
